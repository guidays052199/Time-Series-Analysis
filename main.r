...
par(mfrow=c(2,1))
ts.plot(log_data$`Brent Oil Prices`, fitted(brent_model), col=c("red", "green4"), ylab = "Real x Modelo Brent")
ts.plot(residuals(brent_model), col="blue", ylab="resíduo")

par(mfrow=c(2,1))
ts.plot(log_data$Petrobras, fitted(petr_model), col=c("red", "green4"), ylab = "Real x Modelo Petrobrás")
...
ts.plot(residuals(model), col="blue", ylab="resíduo")
